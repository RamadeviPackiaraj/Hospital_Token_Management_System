    ...
    <div className="flex flex-col gap-3 border-b border-[#E2E8F0] pb-3">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className={`rounded-full border px-3 py-1 ${socketClasses}`}>
            <span className="text-[12px]">{t("chat.headerStatus")}</span>
            <span className="ml-2 text-[14px] font-medium">{socketLabel}</span>
          </div>
          <div className="rounded-full border border-[#E2E8F0] bg-[#F8FAFC] px-3 py-1">
          ...
          <div className="rounded-full border border-[#E2E8F0] bg-white px-3 py-1">
      ...
      <div className="flex flex-col gap-2 xl:flex-row xl:items-center xl:justify-between">
        <div className="relative w-full xl:max-w-[300px]">
          ...
          <Input
            ...
            className="min-h-10 rounded-xl border-[#D8E2EC] bg-white pl-10"
          />
        </div>
